...
<html>
<head>
	<title>Abdel Moneim Medical Center</title>
	...
	<style type="text/css">
		...
		section .table-wrapper:before {
			...
			width: 90%;
			height: 100%;
			border-top: 2px solid #147871;
			border-left: 2px solid #147871;
			z-index: -1;
		}
		section .no-break {
	...
	<section>
		<div class="details clearfix">
			...
			<div class="data right">
				<div class="title">BILL-00{{$Bill->id}}</div>
				<div class="date">
					Date of Bill: {{$Bill->bill_date}}<br><br>
				...
				<table class="grand-total">
					<tbody>
						<tr>
                            ...
                            @endphp
							<td class="grand-total" colspan="5"><div><span>TOTAL:</span>${{$amount}}.00 SDG</div></td>
						</tr>
					</tbody>
				</table>
			</div>
