...
<form method="post" action="{{route('Supplier.update',$Supplier)}}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
            ...
            <div class=" custom-form">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        required autocomplete="off" value="{{ $Supplier->name }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        required autocomplete="off" value="{{ $Supplier->email }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        required autocomplete="off" value="{{ $Supplier->address }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        required autocomplete="off" maxlength="10" value="{{ $Supplier->phone }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="submit" class="form-control btn btn-primary btn-block" value="{{ trans('sentence.UPDATE')}}">
                    </div>
                </div>
