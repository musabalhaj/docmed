	...
	<section>
		<div class="details clearfix">
			<div class="client left">
				<p class="name" style="margin-bottom: 10px;">{{$Appointment->name}}</p>
			...
			<div class="data right">
				<div class="title">{{trans('sentence.Prescription')}} -00{{$Appointment->id}}</div>
				<div class="date">
        ...
        @php
            $Diagnos = DB::table('diagnos')->where('appointment_id',$Appointment->id)->get()->first();
        @endphp
        <div class="container">
			<div class="table-wrapper">
				<table>					
					<tbody class="head">
						<tr>
							<th class="no"></th>
							<th class="desc"><div>{{trans('sentence.Diagnos')}}</div></th>
						</tr>
					</tbody>
					<tbody class="body">
						<tr>
			...
			<div class="table-wrapper">			
				<table>	
					<tbody class="head">
						<tr>
							<th class="no"></th>
							<th class="desc"><div>{{trans('sentence.Tretment')}}</div></th>
						</tr>
					</tbody>
					<tbody class="body">
						<tr>
