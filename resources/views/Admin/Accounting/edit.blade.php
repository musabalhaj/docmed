...
<h6>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('Accounting.index')}}">{{ trans('sentence.Accountant')}}</a></li>
...
@endif
<form method="post" action="{{route('Accounting.update',$Accounting)}}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
            ...
            <div class="row custom-form">
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" value="{{$Accounting->name}}">
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" value="{{$Accounting->address}}">
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" value="{{$Accounting->identity_type}}">
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" maxlength="20" value="{{$Accounting->identity_number}}">
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" value="{{$Accounting->email}}">
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" maxlength="10" value="0{{$Accounting->phone}}">
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        <select class="custom-select mr-sm-2" id="maritalstatus_id" name="maritalstatus_id">
                            @foreach($MaritalStatus as $MaritalStatus)
                                <option value="{{$MaritalStatus->id}}"
                                    @if($MaritalStatus->id == $Accounting->maritalstatus_id)
                                    selected
                                    @endif
                                    >
                        ...
                        <select class="custom-select mr-sm-2" id="bloodsymbol_id" name="bloodsymbol_id">
                            @foreach($BloodSymbol as $BloodSymbol)
                                <option value="{{$BloodSymbol->id}}"
                                    @if($BloodSymbol->id == $Accounting->bloodsymbol_id)
                                    selected
                                    @endif
                                    >
                        ...
                        <select class="custom-select mr-sm-2" id="gender_id" name="gender_id">
                            @foreach($Genderes as $Gender)
                                <option value="{{$Gender->id}}"
                                    @if($Gender->id == $Accounting->gender_id)
                                    selected
                                    @endif
                                    >
                                    {{$Gender->name}}</option>
