...
<h6>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('Bank.index')}}">{{ trans('sentence.Bank')}}</a></li>
...
<form method="post" action="{{route('Bank.update',$Bank)}}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
            ...
            <div class=" custom-form">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        required autocomplete="off" value="{{ $Bank->name }}">
                    </div>
                </div>
