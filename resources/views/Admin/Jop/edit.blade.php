...
<h6>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('Jop.index')}}">{{ trans('sentence.Jops')}}</a></li>
...
<form method="post" action="{{route('Jop.update',$Jop)}}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
            ...
            <div class=" custom-form">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        required autocomplete="off" value="{{ $Jop->name }}">
                    </div>
                </div>
