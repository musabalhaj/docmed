    ...
    <div class="card-block">
        <ul class="nav nav-tabs nav-tabs-top" id="myTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">
                    <i class="fa fa-male"></i> Genders List
                </a>
            </li>
            <li class="nav-item">
        ...
        <div class="tab-content" id="myTabContent">
                ...
                <div class="table-responsive">
                    <table class="table datatable table-light table-hover table-bordered">
                        ...
                        <tr>
                            <td>{{$Gender->name}}</td>
                            <td>
                                <a href="{{route('Gender.edit',$Gender->id)}}" class="btn btn-success btn-sm float-left mr-2">
                                <i class="fa fa-pencil-square-o"></i> 
                                </a>
                                <form method="POST" action="{{route('Gender.destroy',$Gender->id)}}">
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="tab-pane fade" id="add" role="tabpanel" aria-labelledby="add-tab">
                ...
                <form method="post" action="{{route('Gender.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            <div class=" custom-form">
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-sm-2 col-form-label">Gender<span class="star">*</span></label>
                                    <div class="col-sm-10">
