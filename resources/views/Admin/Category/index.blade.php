...
<h6>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ trans('sentence.Categories')}}</li>
        </ol>
    </nav>
</h6>
@if($errors->any())
        ...
        <ul class="nav nav-tabs nav-tabs-top" id="myTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">
                    <i class="fa fa-suitcase"></i> {{ trans('sentence.Categories List')}}
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="add-tab" data-toggle="tab" href="#add" role="tab" aria-controls="add" aria-selected="false">
                    <i class="fa fa-plus"></i> {{ trans('sentence.Add Category')}}
                </a>
            </li>
        </ul>
                ...
                <div class="table-responsive">
                    <table class="table datatable table-light table-hover">
                        ...
                        <tr>
                            ...
                            <td>{{$Category->name}}</td>
                            <td>
                                <a href="{{route('Category.edit',$Category->id)}}" class="btn btn-success btn-sm float-left mr-2">
