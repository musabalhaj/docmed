            ...
            <div class="row custom-form">
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" value="{{$Pharmacy->name}}">
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" value="{{$Pharmacy->address}}">
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" value="{{$Pharmacy->identity_type}}">
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" maxlength="20" value="{{$Pharmacy->identity_number}}">
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" value="{{$Pharmacy->email}}">
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" maxlength="10" value="0{{$Pharmacy->phone}}">
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        <select class="custom-select mr-sm-2" id="maritalstatus_id" name="maritalstatus_id">
                            @foreach($MaritalStatus as $MaritalStatus)
                                <option value="{{$MaritalStatus->id}}"
                                    @if($MaritalStatus->id == $Pharmacy->maritalstatus_id)
                                    selected
                                    @endif
                                    >
                        ...
                        <select class="custom-select mr-sm-2" id="bloodsymbol_id" name="bloodsymbol_id">
                            @foreach($BloodSymbol as $BloodSymbol)
                                <option value="{{$BloodSymbol->id}}"
                                    @if($BloodSymbol->id == $Pharmacy->bloodsymbol_id)
                                    selected
                                    @endif
                                    >
                        ...
                        <select class="custom-select mr-sm-2" id="gender_id" name="gender_id">
                            @foreach($Genderes as $Gender)
                                <option value="{{$Gender->id}}"
                                    @if($Gender->id == $Pharmacy->gender_id)
                                    selected
                                    @endif
                                    >
                                    {{$Gender->name}}</option>
