            ...
            <div class="row custom-form">
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" value="{{$Employee->name}}">
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" value="{{$Employee->address}}">
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" value="{{$Employee->identity_type}}">
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" maxlength="20" value="{{$Employee->identity_number}}">
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" value="{{$Employee->email}}">
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" maxlength="10" value="0{{$Employee->phone}}">
                    </div>
                </div>
                        ...
                        <select class="custom-select mr-sm-2" id="maritalstatus_id" name="maritalstatus_id">
                            @foreach($MaritalStatus as $MaritalStatus)
                                <option value="{{$MaritalStatus->id}}"
                                    @if($MaritalStatus->id == $Employee->maritalstatus_id)
                                    selected
                                    @endif
                                    >
                        ...
                        <select class="custom-select mr-sm-2" id="bloodsymbol_id" name="bloodsymbol_id">
                            @foreach($BloodSymbol as $BloodSymbol)
                                <option value="{{$BloodSymbol->id}}"
                                    @if($BloodSymbol->id == $Employee->bloodsymbol_id)
                                    selected
                                    @endif
                                    >
                        ...
                        <select class="custom-select mr-sm-2" id="gender_id" name="gender_id">
                            @foreach($Genderes as $Gender)
                                <option value="{{$Gender->id}}"
                                    @if($Gender->id == $Employee->gender_id)
                                    selected
                                    @endif
                                    >
                                    {{$Gender->name}}</option>
