...
@endif
<form method="post" action="{{route('Laboratory.update',$Laboratory)}}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
            ...
            <div class="row custom-form">
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" value="{{$Laboratory->name}}">
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" value="{{$Laboratory->address}}">
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" value="{{$Laboratory->identity_type}}">
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" maxlength="20" value="{{$Laboratory->identity_number}}">
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" value="{{$Laboratory->email}}">
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        required autocomplete="off" maxlength="10" value="0{{$Laboratory->phone}}">
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        <select class="custom-select mr-sm-2" id="maritalstatus_id" name="maritalstatus_id">
                            @foreach($MaritalStatus as $MaritalStatus)
                                <option value="{{$MaritalStatus->id}}"
                                    @if($MaritalStatus->id == $Laboratory->maritalstatus_id)
                                    selected
                                    @endif
                                    >
                        ...
                        <select class="custom-select mr-sm-2" id="bloodsymbol_id" name="bloodsymbol_id">
                            @foreach($BloodSymbol as $BloodSymbol)
                                <option value="{{$BloodSymbol->id}}"
                                    @if($BloodSymbol->id == $Laboratory->bloodsymbol_id)
                                    selected
                                    @endif
                                    >
                        ...
                        <select class="custom-select mr-sm-2" id="gender_id" name="gender_id">
                            @foreach($Genderes as $Gender)
                                <option value="{{$Gender->id}}"
                                    @if($Gender->id == $Laboratory->gender_id)
                                    selected
                                    @endif
                                    >
                                    {{$Gender->name}}</option>
