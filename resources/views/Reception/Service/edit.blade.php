...
<h6>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('Service.index')}}">{{ trans('sentence.Services')}}</a></li>
            ...
            <div class=" custom-form">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        required autocomplete="off" value="{{$Service->name}}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea name="description" id="description" class="form-control" cols="5" rows="3">{{$Service->description}}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        required autocomplete="off" maxlength="10" value="{{$Service->price}}">
                    </div>
                </div>
