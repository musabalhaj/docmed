...
<head>
    ...
    <script src="{{ asset('log/vendor/jquery/jquery-3.2.1.min.js') }}" defer></script>
	<script src="{{ asset('log/vendor/animsition/js/animsition.min.js') }}" defer></script>
	<script src="{{ asset('log/vendor/bootstrap/js/popper.js') }}" defer></script>
	<script src="{{ asset('log/vendor/bootstrap/js/bootstrap.min.js') }}" defer></script>
	<script src="{{ asset('log/vendor/select2/select2.min.js') }}" defer></script>
	<script src="{{ asset('log/vendor/daterangepicker/moment.min.js') }}" defer></script>
	<script src="{{ asset('log/vendor/daterangepicker/daterangepicker.js') }}" defer></script>
	<script src="{{ asset('log/vendor/countdowntime/countdowntime.js') }}" defer></script>
